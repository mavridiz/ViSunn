      ...
      <div class="mt-8">
        ...
        <div class="mt-6">
            ...
            <div>
              ...
              <div class="mt-1">
                <input id="correo" name="correo" type="email" autocomplete="email" class="peer appearance-none block w-full px-3 py-2 valid:border-green-500 invalid:border-red-500 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-400 focus:border-blue-400 sm:text-sm">
            ...
            <div class="space-y-1">
              ...
              <div class="mt-1">
                <input id="contra" name="contra" type="password" autocomplete="current-password" minlength="6" maxlength="30" class="appearance-none block w-full px-3 py-2 valid:border-green-500 invalid:border-red-500 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-green-400 focus:border-green-400 sm:text-sm" required>             
              </div>
            </div>
